...
architecture behavioral of controle is
    ...
    constant BLT    : unsigned(3 downto 0) := "1000";
    constant SUBI   : unsigned(3 downto 0) := "1001";
    constant SW     : unsigned(3 downto 0) := "1010";
    constant LW     : unsigned(3 downto 0) := "1011";
...
begin
    ...
    exception <= '1' when (opcode = "1110" or opcode = "1101" or opcode = "1100") else '0';
